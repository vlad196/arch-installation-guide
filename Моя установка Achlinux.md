...
_EOF_
```
### [NVIDIA](Systems/Archlinux/Установка%20Arch/Драйвера/NVIDIA.md)
### [Nouveau](Systems/Archlinux/Установка%20Arch/Драйвера/Nouveau.md)

## Загрузчики:
### [Systemd-boot](Systems/Archlinux/Установка%20Arch/Загрузчики/Systemd-boot.md)
## [GRUB](Systems/Archlinux/Установка%20Arch/Загрузчики/GRUB.md)
...
[[Systems/Archlinux/Установка Arch/Среды рабочего стола/Gnome]]
[[Systems/Archlinux/Установка Arch/Среды рабочего стола/KDE]]
## XDG-USER-DIRS
...
### [[Systems/Archlinux/Установка Arch/Среды рабочего стола/KDE#KDE настройка после перезагрузки|KDE]]

### [[Systems/Archlinux/Установка Arch/Среды рабочего стола/Gnome#Gnome настройка после перезагрузки|Gnome]]
